...
local roomsetting = {
    ...
    kitchen = {
        ...
        addprops = {
            ...
            { name = "shelf_floating", x_offset = -4.5, z_offset = 0, addtags={"playercrafted"} },
            { name = "deco_antiquities_beefalo", x_offset = -5, z_offset = -15/4, addtags={"playercrafted"} },
            ...
            { name = "swinging_light_chandalier_candles", x_offset = -2, z_offset = 0, rotation = -90, addtags = { "playercrafted" } },
            { name = "swinging_light_chandalier_candles", x_offset = 0, z_offset = -6, rotation = -90, addtags = { "playercrafted" } },
            { name = "swinging_light_chandalier_candles", x_offset = 0, z_offset = 6, rotation = -90, addtags = { "playercrafted" } },

            { name = "cookpot", x_offset = 10/4, z_offset = 15/4, rotation = 90, addtags = { "playercrafted" } },
            { name = "cookpot", x_offset = -10/4, z_offset = 15/4, rotation = 90, addtags = { "playercrafted" } },

            { name = "window_tall_curtain_backwall", x_offset = -10/2, z_offset = 4.5, rotation = 90, addtags={"playercrafted"} },

            { name = "icebox", x_offset = -2.5, z_offset = -5.5, rotation = 90, addtags={"playercrafted"} },
            { name = "icebox", x_offset = -2.5, z_offset = -3, rotation = 90, addtags={"playercrafted"} },

            { name = "saltbox", x_offset = 1, z_offset = -5.5, rotation = 90, addtags={"playercrafted"} },
            { name = "saltbox", x_offset = 1, z_offset = -3, rotation = 90, addtags={"playercrafted"} },
    ...
    lab = {
        ...
        walltexture = "levels/textures/interiors/wall_plain_RoG.tex",
        addprops = {
            { name = "deco_roomglow", x_offset = 0, z_offset = 0 },

            { name = "deco_antiquities_beefalo", x_offset = -5, z_offset = 0, addtags = { "playercrafted" } },
            { name = "deco_marble_cornerbeam", x_offset = -5, z_offset = -15 / 2, rotation = 90, flip = true, addtags = { "playercrafted" } },
            { name = "deco_marble_cornerbeam", x_offset = -5, z_offset = 15 / 2, rotation = 90, addtags = { "playercrafted" } },
            { name = "deco_marble_beam", x_offset = 4.7, z_offset = -15 / 2, rotation = 90, flip = true, addtags = { "playercrafted" } },
            { name = "deco_marble_beam", x_offset = 4.7, z_offset = 15 / 2, rotation = 90, addtags = { "playercrafted" } },

            { name = "deco_wallornament_black_cat", x_offset = -5, z_offset = -3.5, addtags = { "playercrafted" } },
            { name = "deco_antiquities_beefalo  ", x_offset = -5, z_offset = 0, addtags = { "playercrafted" } },
            { name = "SHELF_LADDER", x_offset = -4.5, z_offset = 15 / 4, addtags = { "playercrafted" } },

            { name = "moondial", x_offset = -4, z_offset = 0, addtags = { "playercrafted" } },
            { name = "phonograph", x_offset = -4, z_offset = 15/4, addtags = { "playercrafted" } },
            { name = "ancient_altar", x_offset = 1, z_offset = -15/4, addtags = { "playercrafted" } },
            { name = "madscience_lab", x_offset = 2, z_offset = 1, addtags = { "playercrafted" } },
            { name = "sewing_mannequin", x_offset = 2, z_offset = 4.5, addtags = { "playercrafted" } },
        }
    }
}
-- ROOM DIMENSIONS
...
--      +-------------+
--     /[height]      |\
--    / |_____________| \  _ _ _ ----> z-axis (max 7.5)
--   /  /             \  \      \
--   | /       +(0,0)  \ |       \ [depth]
...
function RoomBuilder:CreateNewRoom(door_frame, current_interior, house_id)
    ...
    if self.inst:HasTag("build_kitchen") then
        TheWorld.components.roomsystem:SetRoomType(id,"kitchen")
        roomtype = "kitchen"
    elseif self.inst:HasTag("build_lab") then
        TheWorld.components.roomsystem:SetRoomType(id,"lab")
        roomtype = "lab"
    end
    ...
    interior_spawner:CreateRoom({
        ...
        dungeon_name = name,
        roomindex = id,
        addprops = roomsetting[roomtype]["addprops"],
        exits = room_exits,
        walltexture = roomsetting[roomtype]["walltexture"],
        floortexture = roomsetting[roomtype]["floortexture"],
...
function RoomBuilder:BuildRoom(door_frame, permit)
    ...
    if cause == "CONNECTING" then -- change this logic?
        ...
        self:CreateNewRoom(door_frame, current_interior, house_id)
    end
