...
local function OnSave(inst, data)
    ...
    local roomtype = TheWorld.components.roomsystem:GetRoomTypeById(inst.interiorID)
    if roomtype then
...
local function OnLoad(inst, data)
    ...
    if data.roomtype and data.interiorID then
        TheWorld.components.roomsystem:SetRoomType(data.interiorID,data.roomtype)
    end
end
